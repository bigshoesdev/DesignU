        ...
        <div class="row" style="min-height:850px;">
            ...
            <div class="col-md-12">
                <div class="thumbnail wow slideInLeft" data-wow-duration="3s" style="padding: 10px;">
                    <div class="row">
                        <h3 class="sizesetting-hint alert alert-success">If you set size one time, the system will
                            recommend the size automatically.</h3>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4" style="padding-bottom:10px;">
                            ...
                            <div class="row" style="margin-top: 15px; text-align: center;">
                                <div class="col-md-offset-3 col-md-6">
                                    <button class="btn btn-primary btn-block" id="sizesetting-size-apply">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
