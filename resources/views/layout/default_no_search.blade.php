...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/layout/default_no_search.css') }}">
    <style type="text/css">
        @font-face {
            ...
            <ul class="list-inline">
                <li class="center">
                    <a href="{{route('home')}}">
                        ...
                        <span class="designu-logo-title">
                            @section('logo_title')
                            @show
                        </span>
                    </a>
                </li>
                <li class="pull-right" style="display: flex;align-items: center;">
                    @if(Sentinel::check())
                    ...
                    <a href="{{route('mypage.index')}}" style="margin-right: 10px;">
                        <i class="livicon" data-name="user" data-size="30" data-loop="true"
                           data-c="#fff"
                           data-hc="#757b87"></i>
                    </a>
                    <a href="{{route('home')}}" style="margin-right: 10px;">
                        <i class="livicon" data-name="home" data-size="30" data-loop="true"
                           data-c="#fff"
                           data-hc="#757b87"></i>
                    </a>
                    @if(Sentinel::check())
                        <a href="{{route('auth.logout')}}" style="margin-right:10px;">
                            <i class="livicon" data-name="sign-out" data-size="30" data-loop="true"
                               data-c="#fff"
                               data-hc="#757b87"></i>
                        </a>
                    @else
                        <a href="{{route('auth.login')}}" style="margin-right:10px;">
                            <i class="livicon" data-name="unlock" data-size="30" data-loop="true"
                               data-c="#fff"
                               data-hc="#757b87"></i>
                        </a>
                    @endif
